"""Default Computational Kaleidoscope agent roster.

The roster is configuration, not execution. Every perspective is instantiated
behind the formal Agent contract and remains unable to execute, access brokerage,
or mutate a portfolio.
"""
...
def run_default_agents(question: str, evidence_by_agent=None) -> list[dict]:
    registry = build_default_registry()
    return registry.run_all(question, evidence_by_agent or {agent_id: [] for agent_id, *_ in _ROSTER})
