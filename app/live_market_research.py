...
the existing market-data/evidence integrity pipeline. This module contains no
order, brokerage, credential, or portfolio execution capability.
"""
...
def live_market_research(
    ...
    """Acquire provider observations without applying trading logic."""
